...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting PubSub processing");
    
    let mut processor = PubSubProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = PubSubProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = PubSubProcessor::new(false);
